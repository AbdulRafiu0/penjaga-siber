      ...
      <div className="fixed left-0 top-0 h-full w-64 bg-sidebar border-r border-sidebar-border p-6 flex flex-col justify-between">
        <div>
          ...
          <nav className="space-y-2">
            {['overview', 'applications', 'submissions'].map((tab) => (
